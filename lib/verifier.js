...
class EmailSyntaxError extends Error {
    constructor(error) {
        super(error);
    }
}
exports.EmailSyntaxError = EmailSyntaxError;
function verifyLocalPart(local) {
...
exports.verifyLocalPart = verifyLocalPart;
